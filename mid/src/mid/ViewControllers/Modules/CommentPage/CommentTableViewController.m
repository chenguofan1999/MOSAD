...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(cellItem.isReply)
    {
        ...
        //[replyCell.portraitButton addTarget:self action:@selector(toUserPage:) forControlEvents:UIControlEventTouchUpInside];
        cell = replyCell;
    }
    else
    {
        ...
        //[commentCell.portraitButton addTarget:self action:@selector(toUserPage:) forControlEvents:UIControlEventTouchUpInside];
        // 添加 reply 事件
...
//
//    CommentCellItem *cellItem = _commentItems[i];
//    NSString *userID = [cellItem userID];
//    NSString *userName = [cellItem userName];
//
