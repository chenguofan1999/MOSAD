...
- (instancetype)initWithTypeLikeByUsername:(NSString *)username
{
    self = [super init];
    self.queryParams = [NSMutableDictionary dictionary];
    [self.queryParams setValue:username forKey:@"likedBy"];
    self.tableType = OrderedVideoListTableTypeLike;
    self.orderMode = UserVideoListTableOrderByTimeDesc;
    
    _headerTitle = [[UILabel alloc]init];
    [_headerTitle setText:[NSString stringWithFormat:@"Liked by %@",username]];
    [_headerTitle setFont:[UIFont boldSystemFontOfSize:24]];
    return self;
}
...
- (instancetype)initWithTypeSelf
{
    self = [super init];
    self.queryParams = [NSMutableDictionary dictionary];
    [self.queryParams setValue:@"true" forKey:@"self"];
    self.tableType = OrderedVideoListTableTypeSelf;
    self.orderMode = UserVideoListTableOrderByTimeDesc;
    
    _headerTitle = [[UILabel alloc]init];
    [_headerTitle setText:@"Your Uploads"];
    [_headerTitle setFont:[UIFont boldSystemFontOfSize:24]];
    return self;
}
